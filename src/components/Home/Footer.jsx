          ...
          <div className="question flex flex-col gap-6 laptop:gap-3">
            ...
            <div className="flex flex-col gap-2 laptop:gap-1">
              <div className="question_map flex gap-2 items-center">
                <i className="fa-solid fa-map text-webpurple tablet:text-[.6rem] phoneL:text-[.5rem] phoneP:text-[.6rem]"></i>
                <p className="text-[#BCBCBE] text-nowrap laptop:text-[11px] tablet:text-[10px] phoneL:text-[10px] phoneP:text-[9px]">
                  Omu-Aran, Kwara-State
                </p>
              </div>
              <div className="question_phone flex items-center gap-2">
                <i className="fa-solid fa-phone text-webpurple text-[.6rem] phoneL:text-[.5rem] phoneP:text-[.6rem]"></i>
                <p className="text-[#BCBCBE] text-nowrap laptop:text-[11px] tablet:text-[10px] phoneL:text-[10px] phoneP:text-[9px]">
                  +234 815 9531 614
                </p>
              </div>
