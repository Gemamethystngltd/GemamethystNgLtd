function BlogDetails() {
  return (
    <div className="blog_details flex items-centerg gap-2 shadow-lg rounded-lg w-fit bg-white p-2 absolute top-[43%] left-[15%] laptop:top-[47%] tablet:top-[43%] tablet:left-[10%] phoneL:left-[18%] phoneL:top-[52%] phoneP:top-[51%] phoneP:left-[15%]">
