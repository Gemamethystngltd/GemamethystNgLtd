    ...
    <>
      <section className="sub_hero_section relative flex items-end h-[85vh] p-8  tablet:p-4 phoneL:p-2">
        ...
        <div className="sub_hero_content flex flex-col gap-4 ml-[10%] z-10 tablet:ml-[3%] tablet:gap-2 phoneL:gap-1 phoneL:ml-[1%] ">
          <header className=" tablet:text-[.6rem] phoneL:text-[.7rem] phoneP:text-[.6rem]">
          ...
          <h2 className="uppercase text-[40px] leading-[50px] font-bold text-white tablet:text-[30px] tablet:leading-[30px] phoneL:text-[25px] phoneL:leading-[30px] phoneP:text-[15px] phoneP:leading-[20px]">
            {page}
          </h2>
        </div>
      </section>
